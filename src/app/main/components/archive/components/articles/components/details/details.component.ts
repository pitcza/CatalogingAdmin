...
export class DetailsComponent {
  ...
  restoreBox(accession: any){
    Swal.fire({
      ...
      text: 'Are you sure you want to restore this ' + this.type.toLowerCase() + ' article?',
      icon: 'question',
        ...
        this.ds.request('POST', 'materials/restore/' + accession, null).subscribe({
          next: (res: any) => {
            Swal.fire({
              ...
              text: "The " + this.type.toLowerCase() + " article has been restored successfully.",
              icon: "success",
  ...
  deleteBox(accession: any){
    Swal.fire({
      ...
      text: 'Are you sure you want to permanently delete this ' + this.type.toLowerCase() + ' article? This action cannot be undone.',
      icon: 'warning',
      showCancelButton: true,
      confirmButtonText: 'Yes',
      cancelButtonText: 'Cancel',
        ...
        this.ds.request('DELETE', 'permanently-delete/materials/' + accession, null).subscribe({
          next: (res: any) => {
            Swal.fire({
              ...
              text: "The " + this.type.toLowerCase() + " article has been permanently deleted and cannot be recovered.",
              icon: "success",
              confirmButtonText: 'Close',
              confirmButtonColor: "#777777",
              scrollbarPadding: false,
